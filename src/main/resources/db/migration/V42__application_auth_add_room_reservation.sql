...
INSERT INTO public.ccr_user_authority (authority_id, content, name, route, parent_id, type, icon, enabled, http_method) VALUES (101, 'reservation-setting', '产品配置', '/reservation-setting', 97, 'm2654_menu', null, true, null);
